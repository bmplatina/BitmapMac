...
README supports English and Korean / README 파일은 영어와 한국어를 지원합니다. 한국어 설명은 아래를 참조하세요.<br>
This project is deprecated due to cross platform support. Please visit [bmplatina/bitmap](https://github.com/bmplatina/bitmap.git).<br>
이 프로젝트는 크로스 플랫폼 지원을 위해 폐기되었습니다. [bmplatina/bitmap](https://github.com/bmplatina/bitmap.git)을 참조해주세요.
